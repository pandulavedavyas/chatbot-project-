  ...
  return (
    ...
    >
      {isUser ? (
        ...
        <div className="group max-w-[85%] md:max-w-[80%] flex items-start gap-3">
            ...
            <div className="flex items-center gap-2 mb-1.5">
              ...
              {message.streaming && (
                <span className="inline-flex items-center gap-1">
                  ...
                  <span className="w-1.5 h-1.5 bg-primary-400 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }} />
                  <span className="w-1.5 h-1.5 bg-primary-400 rounded-full animate-pulse" style={{ animationDelay: '0.4s' }} />
                </span>
              )}
            </div>
                      ...
                      return match ? (
                        <div className="relative my-3">
                          ...
                          <SyntaxHighlighter
                            ...
                            customStyle={{ margin: 0, borderTopLeftRadius: 0, borderTopRightRadius: 0, background: '#0f172a' }}
                          >
